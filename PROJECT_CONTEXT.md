...
- 適用範圍：11 大系統、53 個子系統；一般頁面由 `web/components/SystemPageHeader.tsx`
...
- 全螢幕例外：平面樓層圖、3D 模型圖、立體巡檢雲臺使用圖面頂列的緊湊標題版，仍保留
...
- 防回歸：`npm run test:page-headings` 會確認 10／53 數量、標準 token、Logo 存在與
  49 個一般頁首＋3 個全螢幕緊湊頁首的覆蓋。

- 53 個子系統圖卡標準：桌面瀏覽器 100% 固定 269×200px；一般頁首沿用距頂列 22px、
