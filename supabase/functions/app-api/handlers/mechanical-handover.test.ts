...
test('日期、班別、動作、接班人及快照版本必須有效', async () => {
  for (const body of [{ handover_date: '2026-02-30' }, { handover_date: '2026-09-15', shift_code: 'bad', operation: 'submit', receiver_id: '00000000-0000-0000-0000-000000000002', revision: 'a'.repeat(32) },
    { handover_date: '2026-09-15', shift_code: '01-09', operation: 'submit', receiver_id: 'bad', revision: 'a'.repeat(32) },
    { handover_date: '2026-09-15', shift_code: '01-09', operation: 'receive', revision: 'old' }]) {
...
test('簽認身分與時間只由交易式 RPC 取得', async () => {
  ...
  assert.deepEqual(r.calls, [['mechanical_handover_action', { p_action: 'submit', p_date: '2026-09-15', p_shift: '01-09', p_receiver: '00000000-0000-0000-0000-000000000002', p_revision: 'a'.repeat(32) }]]);
});
