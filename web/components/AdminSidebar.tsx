...
const sidebarItems: SidebarItem[] = [
  ...
  { href: '/systems/admin/layouts/', label: '戰情版面設定', icon: '/Inspection/assets/system-icons-v20260901/admin-icon.png', adminOnly: true },
  {
    ...
    label: '系統設定',
    icon: '/Inspection/assets/system-icons-v20260901/settings-icon.png',
    adminOnly: true,
    activePaths: [
  ...
  { href: '/systems/admin/alerts/', label: '資安告警', icon: '/Inspection/assets/system-icons-v20260901/audit-icon.png', adminOnly: true },
  { href: '/systems/admin/health/', label: '系統健康', icon: '/Inspection/assets/system-icons-v20260901/settings-icon.png', adminOnly: true },
];
    ...
    <aside id="admin-v2-sidebar" className={`admin-sidebar${open ? ' is-open' : ''}`} aria-label="後台管理側邊導覽">
      ...
      <div className="admin-sidebar-profile">
        ...
        <button type="button" onClick={() => { onClose(); onChangePassword(); }}>
          <img src="/Inspection/assets/system-icons-v20260901/account-icon.png" alt="" />
          個人資料設定
        </button>
      </div>
    </aside>
