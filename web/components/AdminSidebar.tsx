...
const sidebarItems: SidebarItem[] = [
  ...
  { href: '/systems/admin/layouts/', label: '戰情版面設定', icon: '/word-cloud/assets/system-icons/admin-icon.png', adminOnly: true },
  {
    href: '/systems/admin/settings/',
    label: '系統設定',
    icon: '/word-cloud/assets/system-icons/settings-icon.png',
    adminOnly: true,
    activePaths: [
  ...
  { href: '/systems/admin/users/', label: '帳號管理', icon: '/word-cloud/assets/system-icons/account-icon.png', adminOnly: true },
  { href: '/systems/equipment/', label: '設備建置管理', icon: '/word-cloud/assets/system-icons/equipment-icon.png', system: 'equipment' },
  { href: '/systems/workorder/', label: '維修／派工／完工系統', icon: '/word-cloud/assets/system-icons/maintenance-icon.png', system: 'workorder' },
  { href: '/systems/guardpatrol/', label: '駐衛警巡檢系統', icon: '/word-cloud/assets/system-icons/guardpatrol-icon.png', system: 'guardpatrol' },
  { href: '/systems/handover/', label: '電子交接簿', icon: '/word-cloud/assets/system-icons/handover-icon.png', system: 'handover' },
  { href: '/systems/structuremap/models/', label: '3D 雲臺建模', icon: '/word-cloud/assets/system-icons/equipment-icon.png', system: 'structuremap' },
  { href: '/systems/structuremap/relations/', label: '專案關係地圖', icon: '/word-cloud/assets/system-icons/settings-icon.png', system: 'structuremap' },
  { href: '/systems/equipment/costs/', label: '費用統計', icon: '/word-cloud/assets/system-icons/audit-icon.png', system: 'equipment' },
  {
    href: '/systems/admin/audit/',
    label: '系統紀錄',
    icon: '/word-cloud/assets/system-icons/audit-icon.png',
    adminOnly: true,
    ...
    <aside id="admin-v2-sidebar" className={`admin-sidebar${open ? ' is-open' : ''}`} aria-label="後台管理側邊導覽">
      ...
      <div className="admin-sidebar-profile">
        ...
        <button type="button" onClick={() => { onClose(); onChangePassword(); }}>
          <img src="/word-cloud/assets/system-icons/account-icon.png" alt="" />
          更改密碼
        </button>
      </div>
    </aside>
