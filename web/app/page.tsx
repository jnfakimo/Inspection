  ...
  return <AppShell profile={profile} title="戰情儀表板">
    ...
    {!data ? <div className="panel loading-panel">正在彙整巡檢、設備與維修數據…</div> : <>
      ...
      <section className="dashboard-grid">
        ...
        <article className="panel"><div className="panel-head"><h2>近期維修事件</h2><a href="/word-cloud/system/admin.html?v=8f9d41c#repairs">開啟完整流程</a></div><DataList rows={data.recent_repairs} empty="目前沒有維修事件" /></article>
