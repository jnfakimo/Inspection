...
function Floor3DViewer({ module, profile }: Props) {
  ...
  return <AppShell profile={profile} title={module.title}>
    ...
    <section className="panel admin-panel" style={{ flex: 1, minHeight: 'calc(160vh - 160px)', position: 'relative', overflow: 'hidden', display: 'flex', flexDirection: 'column', padding: 0, background: 'var(--panel)' }}>
      {/* 左側浮動面板群 */}
