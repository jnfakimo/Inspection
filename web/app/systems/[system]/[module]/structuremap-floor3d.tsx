...
export function Floor3DBoardModule({ profile }: Props) {
  ...
  // ?kind=patrol：從駐衛警巡邏的立體巡檢雲臺跳過來時只看巡邏點。不另外複製一份
  ...
  return <div className="f3-root">
    ...
    <div className="f3-topbar" data-system-page-heading="compact" data-system-key="structuremap" data-module-key="floor3d">
      ...
      <img className="tb-system-icon" src="/Inspection/assets/system-icons-v20260913/structuremap-icon.png" alt="" data-system-page-logo />
