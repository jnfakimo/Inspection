...
// 節點也換成 V2 現行的十三個系統與其後端相依，點擊直接進到對應的 V2 系統。
//
...
const SYSTEMS = [
  ...
  { key: 'officialdocs', code: 'SYS-09', label: '公文傳送', x: 40, y: 350 },
  { key: 'marketanalytics', code: 'SYS-10', label: '市場營運分析', x: 260, y: 350 },
  { key: 'dashboard', code: 'SYS-11', label: '戰情儀表板', x: 480, y: 350 },
  { key: 'marketboard', code: 'SYS-12', label: '市場公開看板', x: 700, y: 350 },
  { key: 'vehicletracking', code: 'SYS-13', label: '公務車定位追蹤', x: 40, y: 450 },
];
const BACKEND = [
  { label: 'app-api / admin-api', hint: 'JWT · RBAC · 業務流程', x: 40, y: 570, w: 260 },
  { label: 'PostgreSQL + RLS', hint: '最後一道資料庫防線', x: 330, y: 570, w: 260 },
  { label: 'Storage · Realtime · FCM', hint: '附件、即時更新與推播', x: 620, y: 570, w: 300 },
];
...
export function SystemRelations() {
  ...
  return <section className="panel admin-panel">
    ...
    <div className="responsive-table">
      <svg viewBox="0 0 960 660" role="group" aria-label="十三個系統與後端服務的關係圖" style={{ width: '100%', minWidth: 720, height: 'auto' }}>
        <defs>
        ...
        <line x1="480" y1="512" x2="480" y2="548" stroke="var(--line)" strokeWidth="1.4" markerEnd="url(#rel-arrow)" color="var(--line)" />
        <line x1="60" y1="548" x2="900" y2="548" stroke="var(--line)" strokeWidth="1.4" />
        <text x="496" y="564" fill="var(--dim)" fontSize="11">十三個系統共用同一份資料與權限</text>
