...
const ACTION_LABELS: Record<string, string> = {
  create: '建立公文', barcode_generated: '產生文號', send_co_sign: '送出會辦', receive: '收文', co_sign_complete: '會辦完成', send_approval: '送出陳核', approval_receive: '陳核簽收', approve: '核決完成', return: '退回補正', resubmit: '補正重送', originator_receive: '原申請人收訖',
};
