...
function OfficialDocsPage({ profile, system, module }: { profile: Profile; system: SystemDefinition; module: ModuleDefinition }) {
  ...
  const rootDepartments = useMemo(() => (data?.scope_root_departments || []).filter(department => !department.parent_id), [data?.scope_root_departments]);
