...
const cardVisuals = [
  { icon: '/word-cloud/assets/system-icons/account-icon.png', accent: '#00bde8' },
  { icon: '/word-cloud/assets/system-icons/account-icon.png', accent: '#4f8cff' },
  { icon: '/word-cloud/assets/system-icons/guardpatrol-list-icon.png', accent: '#00c985' },
  { icon: '/word-cloud/assets/system-icons/audit-icon.png', accent: '#9b70e8' },
  { icon: '/word-cloud/assets/system-icons/guardpatrol-icon.png', accent: '#ef5b87' },
  { icon: '/word-cloud/assets/system-icons/guardpatrol-line-push-icon.png', accent: '#e5a100' },
  { icon: '/word-cloud/assets/system-icons/admin-icon.png', accent: '#00bde8' },
] as const;
