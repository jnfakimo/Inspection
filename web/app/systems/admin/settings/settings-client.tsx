...
const cards: SettingsCard[] = [
  {
    ...
    icon: '/word-cloud/assets/system-icons/admin-icon.png',
    accent: '#00a9d6',
    section: 'identity',
  },
  {
    ...
    icon: '/word-cloud/assets/system-icons/account-icon.png',
    accent: '#3977e8',
    section: 'departments',
  },
  {
    ...
    icon: '/word-cloud/assets/system-icons/handover-icon.png',
    accent: '#00a86b',
    section: 'shifts',
  },
  {
    ...
    icon: '/word-cloud/assets/system-icons/guardpatrol-line-push-icon.png',
    accent: '#7657d6',
    section: 'line',
  },
  {
    ...
    icon: '/word-cloud/assets/system-icons/equipment-icon.png',
    accent: '#d14e78',
