...
foreach ($required in @('app-api\index.ts', 'app-api\validate.ts', 'app-api\audit.ts', 'app-api\handover-market.ts', 'app-api\handlers\vehicle.ts', 'app-api\handlers\meeting.ts', 'app-api\handlers\patrol-shifts.ts', 'app-api\handlers\business-handover.ts', 'app-api\handlers\mechanical-handover.ts', 'app-api\handlers\handover-market.ts', '_shared\security-monitor.ts', '_shared\password-policy.ts', '_shared\floor.ts', '_shared\client-ip.ts')) {
