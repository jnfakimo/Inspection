...
// Scaled from the platform monitor's 1,000／500 requests per 20 minutes.
const EDGE_TRAFFIC_THRESHOLD = integerEnv("SYNTHETIC_EDGE_TRAFFIC_THRESHOLD", 750, 10, 100_000);
const STORAGE_TRAFFIC_THRESHOLD = integerEnv("SYNTHETIC_STORAGE_TRAFFIC_THRESHOLD", 375, 10, 100_000);
const NOW = new Date();
